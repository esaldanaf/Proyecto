...
<head>
    ...
    <title>Mis Incidencias - Panel Usuario</title>
    <!--Favicon-->
...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
        ...
        <div class="collapse navbar-collapse" id="barraNavegacion">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active-nav-link" href="<?php echo base_url() . "index.php/Usuario/verMisIncidencias" ?>">Mis Incidencias</a>
                </li>
    ...
    <main class="container-fluid">
        ...
        <div class="btn-group float-right" role="group" aria-label="Basic example">
            <!--Botonera Filtrado-->
            <form action="<?php echo base_url() . "index.php/Usuario/filtrarIncidencia"; ?>" method="POST" id="filtraIncidencias">
        ...
        <div class="table-responsive">
            <form action="<?php echo base_url() . "index.php/Usuario/verIncidencia"; ?>" method="POST" id="misIncidencias">
                <table class="table table-hover">
                    ...
                    <tbody>
                        <?php
                        foreach ($misIncidencias as $filaIncidencia) {
