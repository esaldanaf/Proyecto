...
<head>
    ...
    <title>Asignar Incidencia - Panel Técnico</title>
    <!--Favicon-->
...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
        ...
        <div class="collapse navbar-collapse" id="barraNavegacion">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a class="nav-link active-nav-link" href="<?php echo base_url() . "index.php/Tecnico/verAsignaIncidencia" ?>">Nuevas Incidencias</a>
                </li>
                <li class="nav-item">
    ...
    <main class="container-fluid">
        ...
        <div class="table-responsive">
            <form action="<?php echo base_url() . "index.php/Tecnico/asignarIncidencia"; ?>" method="POST" id="nuevasIncidencias">
                <table class="table table-hover">
                    ...
                    <tbody>
                        <?php
                        foreach ($nuevasIncidencias as $filaIncidencia) {
                            echo '<tr class="table-secondary">
                                    ...
                                    <td><button class="btn btn-info" type="submit" name="asignar" id="asignar" value=' . $filaIncidencia['id'] . '>Asignar</button></td>
                                </tr>';
                        } ?>
