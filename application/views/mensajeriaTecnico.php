...
<head>
    ...
    <title>Mensajería - Panel Técnico</title>
    <!--Favicon-->
...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
        ...
        <div class="collapse navbar-collapse" id="barraNavegacion">
            ...
            <ul class="nav navbar-nav ml-auto" style="float: right !important;">
                <li class="nav-item">
                    <a class="nav-link active-nav-link" href="<?php echo base_url() . "index.php/Chat/verMensajeriaTecnico" ?>">Mensajería</a>
                </li>
                <li class="nav-item">
    ...
    <main role="main" class="container">
        <h3>Elige un usuario con el cual quieras hablar:</h3>
        
        <div class="container-fluid ">
            <div class="usuariosChat">
                <form action="<?php echo base_url() . "index.php/Chat/abrirChatTecnico"; ?>" method="POST" id="botoneraChat">
                    <?php foreach ($usuariosChat as $botonUsuario) {
                        echo '
                        <p><button type="submit" name="idUsuario" value="' . $botonUsuario['id'] . '" class="btn btn-primary btn-block">' . $botonUsuario['uNick'] . ' ID:' . $botonUsuario['id'] . '</button></p>
                        ';
                    } ?>
                </form>
            </div>
